...
const RightSidebar = ({ selectedUser }) => {
  return selectedUser && (
    <div className={`h-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? '' : 'md:hidden'}`}>
      <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        <img src={selectedUser?.profilePic || assets.avatar_icon} alt="" className='w-20 
